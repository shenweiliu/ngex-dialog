...
import { ExDialog, DialogService, NgExDialogConfig} from "../ngex-dialog/dialog.module";
...
export class AppComponent implements OnInit {
  ...
  constructor(private router: Router,
    private exDialog: ExDialog, private ngExDialogConfig: NgExDialogConfig,
    private dialogService: DialogService, private renderer: Renderer2) {      
    }
