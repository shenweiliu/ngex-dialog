...
import { DialogComponent, DialogService, ExDialog, DialogCache } from "../ngex-dialog/dialog.module";
...
export class ProductComponent extends DialogComponent implements OnInit {    
    ...
    constructor(dialogService: DialogService,
         private exDialog: ExDialog, private testData: TestDataService) {
      super(dialogService);
